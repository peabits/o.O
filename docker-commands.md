...
Global Options:
  ...
  -l, --log-level string   Set the logging level ("debug", "info",
      ...
      --tlscacert string   Trust certs signed only by this CA (default
                           "C:\\Users\\qwj\\.docker\\ca.pem")
      --tlscert string     Path to TLS certificate file (default
                           "C:\\Users\\qwj\\.docker\\cert.pem")
      --tlskey string      Path to TLS key file (default
                           "C:\\Users\\qwj\\.docker\\key.pem")
...
- `docker help ps`
    ...
    |`--filter filter`|`-f`||根据提供的条件过滤输出|
    |`--format string`||`table`||
    |`--last int `|`-n`|`-1`|Show n last created containers (includes all states) (default -1)|
